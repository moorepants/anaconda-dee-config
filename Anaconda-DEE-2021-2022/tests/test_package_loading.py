...
#
# MUST be run in a anaconda shell
# -------------------------------
...
Bart Gerritsen, EWI, Summer 2021
...
def get_expected_pkgs():
    ...
    or using: `conda list --name base` on the command line. Some *obscure entries* can be filtered out immediately. Special attention to modules installed using `pip`; see the documentation. Trust `conda` and Anaconda's `pip`(!)to have managed the correct versions (no need to check).
    ...
    expected_pkgs = {
        ...
        "beautifulsoup4": "bs4",
        "bitarray": "bitarray",
        #"bokeh": "bokeh.plotting",  # needed for import of bkcharts; still fails
        #"bkcharts": "bkcharts",
        "black": "black",
        #"blas": "blas", C/C++ lib?
        "bleach": "bleach",
        ...
        "jupyter_highlight_selected_word": "jupyter_highlight_selected_word",
        # "jupyter_latex_envs": "jupyter_latex_envs",  nbextension
